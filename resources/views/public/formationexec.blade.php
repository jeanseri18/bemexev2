    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-12  col-md-12 col-12">
                ...
                <p> Nos programmes de formation exécutive s’adressent aux cadres et dirigeants d’entreprises ayant un besoin de connaissances spécifique dans des domaines clés liés au management et à la gestion d’organisations.
                Nous dispensons la plupart de nos formations en partenariat avec des écoles de commerce internationales.</p>
                <br>
                ...
                <div class="row gy-4 gy-xl-0">
                    <div class="col-xl-6 col-md-6 col-12 " style="height:200px">
                        <div class="card card-lift h-100 text-center text-lg-start bg-primary text-white ">
                            <div class="p-2">
                            <a href="{{ asset('pdf/BEM  ESSEC Executive Education -Détail des Modules  Administrateurs Banques (1) 1.pdf') }}"><img src="" alt=""
                                        class="img-fluid rounded-3 w-100"></a>
                            </div>
                            <div class="card-body pt-2 text-center ">
                                <h3> <a href="{{ asset('pdf/BEM  ESSEC Executive Education -Détail des Modules  Administrateurs Banques (1) 1.pdf') }}" class="text-white text-center" href="#!">ADMINISTRATEUR DE BANQUE </a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6 col-12" style="height:200px">
