            ...
            <div class="col-lg-12 col-md-12">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-12 col-md-12 col-12 mb-1 ">
                        <center>
                            <h1 class="display-5 fw-bold Justify-content-center">Nos plus grandes forces</h1>
                        </center><br>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-12 col-md-12 col-12 mb-1 ">
                        <center>
                            <h1 class="display-5 fw-bold Justify-content-center">Nos partenaires académiques</h1>
                        </center><br>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-12 col-md-12 col-12 mb-1 ">
                        <center>
                            <h1 class="display-5 fw-bold Justify-content-center">Les entreprises qui nous ont fait confiance </h1>
                        </center><br>
                    </div>
                    ...
                    <div class="col-xl-12 col-md-12 col-12">
                        <div class="mb-lg-12 mb-6">
                            <center>
                                ...
                                <p class="lead mb-0 container" style="font-size:14px">Booster votre carrière grâce aux
                                    formations professionnelles de BEM EXECUTIVE EDUCATION
                                    Outre les modalités de financement individuel adaptées, il est possible chez BEM
                                    EXECUTIVE EDUCATION
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-12 mb-3">
                                <div class="card" style="height:320px">
                                    <div class="card-body text-center">
                                        <div class="display-4 text-primary mb-3">
                                            <img src="../../assets/Logo-FDFP-recadre.png" width="150px">
                                        </div>
                                        <h3 class="fw-semibold mb-2">FDFP</h3>
                                        <p class="fs-4 mb-0">
                                            Toutes nos formations sont éligibles au Fond de Développement de la
                                            Formation Professionnelle (FDFP), qui fait partie d’un dispositif de
                                            formation professionnelle mis en œuvre en 1991, dans le cadre d’un Programme
                            ...
                            <div class="col-lg-6 col-md-6 col-12 mb-3">
                                <div class="card" style="height:320px">
                                    <div class="card-body text-center">
                                        <div class="display-4 text-primary mb-3">
                                            <img src="../../assets/bank-64.png" width="90px">
                                        </div>
                                        <h3 class="fw-semibold mb-2">Partenaire Bancaire</h3>
                                        <p class="fs-4 mb-0">Nous avons des accords-cadres avec des institutions
                                            bancaires pour vous aider à obtenir le soutien financier nécessaire pour
                                            réaliser votre projet de formation.</p>
                                    </div>
                                </div>
                            </div>
