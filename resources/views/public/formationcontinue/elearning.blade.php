...
@section('title', ' E-learning | Bem executive school')
<style>
.card-custom {
    min-height: 390px;
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-12 col-12">
                        <div class="mb-5 mb-lg-0">
                            <h2 class="display-4 fw-bold mb-3 text-white">
                                Formation
                                <u class="text-warning"><span class="text-white"> en ligne</span></u>
                            </h2>
                            <p class="mb-5 lead">
                    ...
                    <div class="col-lg-6 offset-lg-1 col-md-12 col-12">
                        <div class="d-flex justify-content-center align-items-center position-relative rounded border-gray-100 border border-4 rounded-3 bg-cover"
                            style="background-image: url(../../assets/images/formationorg/entrepreneur-using-video-call-conference-laptop-talk-colleague-startup-office-business-man-attending-online-teleconference-meeting-with-person-discuss-project-strategy.jpg); height: 300px">
                ...
                <div class="container mt-lg-6">
                    <div class="row mb-6 justify-content-center">
                        <div class="col-lg-12 col-md-12 col-12 text-left">
                            <span class="text-primary mb-0 d-block text-uppercase fw-semibold ls-xl">Nos
                                partenaires</span>
                        </div>
                    </div>
                                        ...
                                        <div class="row" id="partenairesContainer">
                                            <div class="col-lg-2 col-md-4 col-6">
                                                <div class="mb-4 text-center">
                                                    <img src="pdf/Logo.png" alt="logo" height="70px">
                                                </div>
                                            </div>
                        ...
                        <div class="card card-hover">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="mb-2 text-truncate-line-2"><a
                                        href="{{ asset('pdf/FICHE CAPITAL HUMAIN 1.pdf') }}"
                                        class="text-inherit">Capital humain</a></h4>
                                <!-- List -->
                                <small>Programme axé sur le leadership dans le secteur public, avec un accent sur
                                    l'innovation et la gestion des politiques publiques.</small>
                            </div>
                            <!-- Card Footer -->
                        </div><br>
                    </div>
                    ...
                    <div class="col-md-4 container" aria-hidden="true" tabindex="-1">
                        ...
                        <div class="card card-hover">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="mb-2 text-truncate-line-2"><a
                                        href="{{ asset('pdf/Supply_Chain_Management_Syllabus (2) 1.pdf') }}"
                                        class="text-inherit">Certificat international Supply chain</a></h4>
                                <!-- List -->
                                <small>Formation sur la méthodologie Lean Six Sigma pour améliorer les processus et la
                                    qualité dans les organisations.</small>
                            </div>
                            <!-- Card Footer -->
                        </div><br>
                    </div>
                    ...
                    <div class="col-md-4 container" aria-hidden="true" tabindex="-1">
                        ...
                        <div class="card card-hover">
                            <a href="{{ asset('pdf/FICHE INNONVATION & CREATIVE 1.pdf') }}">
                                <img src="../../assets/images/certif/Capture d’écran 2024-09-16 à 18.14.49.png"
                                    alt="course" class="card-img-top">
                            </a>
                            <!-- Card Body -->
                            <div class="card-body">
                                ...
                                <h4 class="mb-2 text-truncate-line-2"><a
                                        ...
                                        class="text-inherit">Innovation créative</a></h4>
                                <!-- List -->
                                <small>Programme combinant les méthodologies de gestion de projet prédictives et agiles
                                    pour une flexibilité maximale.</small>
                            </div>
                            <!-- Card Footer -->
                        </div><br>
                    </div>
                    ...
                    <div class="col-md-4 container" aria-hidden="true" tabindex="-1">
                        ...
                        <div class="card card-hover">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="mb-2 text-truncate-line-2"><a
                                        href="{{ asset('pdf/FICHE COM RELATION P 1.pdf') }}"
                                        class="text-inherit">Communication et relations publiques</a></h4>
                                <!-- List -->
                                <small>Programme sur la gestion de la communication, des relations avec les médias et
                                    des stratégies de relations publiques.</small>
                            </div>
                            <!-- Card Footer -->
                        </div><br>
                    </div>
                        ...
                        <div class="card card-hover">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="mb-2 text-truncate-line-2"><a
                                        ...
                                        class="text-inherit">Business development et marketing</a></h4>
                                <!-- List -->
                                <small>Programme sur la gestion du développement des affaires et les stratégies de
                                    marketing pour les entreprises en croissance.</small>
                            </div>
                            <!-- Card Footer -->
                        </div><br>
                    </div>
