                        ...
                        <div class="col-xl-10 offset-xl-1 col-md-12 col-12">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6 offset-lg-1 col-md-12 col-12">
                                    <div class="d-flex justify-content-center align-items-center position-relative rounded border-gray-100 border border-4 rounded-3 bg-cover" style="background-image: url(../../assets/images/formationorg/entrepreneur-using-video-call-conference-laptop-talk-colleague-startup-office-business-man-attending-online-teleconference-meeting-with-person-discuss-project-strategy.jpg); height: 300px">
    ...
    <div class="col-md-4 container" aria-hidden="true" tabindex="-1">
        ...
        <div class="card card-hover">
            ...
            <div class="card-body">
                ...
                <h4 class="mb-2 text-truncate-line-2"><a href="{{ asset('pdf/FICHE CAPITAL HUMAIN 1.pdf') }}" class="text-inherit">Capital humain</a></h4>
                <!-- List -->
    ...
    <div class="col-md-4 container" aria-hidden="true" tabindex="-1">
        ...
        <div class="card card-hover">
            ...
            <div class="card-body">
                ...
                <h4 class="mb-2 text-truncate-line-2"><a href="{{ asset('pdf/Supply_Chain_Management_Syllabus (2) 1.pdf') }}" class="text-inherit">Certificat international Supply chain</a></h4>
                <!-- List -->
    ...
    <div class="col-md-4 container" aria-hidden="true" tabindex="-1">
        ...
        <div class="card card-hover">
            ...
            <div class="card-body">
                ...
                <h4 class="mb-2 text-truncate-line-2"><a href="{{ asset('pdf/FICHE INNONVATION & CREATIVE 1.pdf') }}" class="text-inherit">Innovation créative</a></h4>
                <!-- List -->
    ...
    <div class="col-md-4 container" aria-hidden="true" tabindex="-1">
        ...
        <div class="card card-hover">
            ...
            <div class="card-body">
                ...
                <h4 class="mb-2 text-truncate-line-2"><a href="{{ asset('pdf/FICHE COM RELATION P 1.pdf') }}" class="text-inherit">Communication et relations publiques</a></h4>
                <!-- List -->
                <small>Programme sur la gestion de la communication, des relations avec les médias et des stratégies de relations publiques.</small>
            </div>
            <!-- Card Footer -->
        </div><br>
    </div>
    ...
    <div class="col-md-4 container" aria-hidden="true" tabindex="-1">
        ...
        <div class="card card-hover">
            ...
            <div class="card-body">
                ...
                <h4 class="mb-2 text-truncate-line-2"><a href="{{ asset('pdf/FICHE BUSINESS D & MARKETING 1.pdf') }}" class="text-inherit">Business development et marketing</a></h4>
                <!-- List -->
                <small>Programme sur la gestion du développement des affaires et les stratégies de marketing pour les entreprises en croissance.</small>
            </div>
            <!-- Card Footer -->
        </div><br>
    </div>
