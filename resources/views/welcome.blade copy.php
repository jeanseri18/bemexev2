        ...
        <div class="row">
            <div class="col-lg-12 ">
                <div class="text-center mb-7 pb-2">
                    <h2 class="mb-3">Découvrez Nos Partenaires académiques  :</h2>
                </div>
            </div>
        </div>
